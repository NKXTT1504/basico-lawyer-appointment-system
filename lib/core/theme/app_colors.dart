...
class AppColors {
  // Primary Colors (unified dark blue across app)
  static const Color primary = Color(0xFF1E3A8A); // Dark Blue
  static const Color onPrimary = Color(0xFFFFFFFF);
  static const Color primaryContainer = Color(0xFFDBEAFE);
  static const Color onPrimaryContainer = Color(0xFF0F1F4B);

  // Secondary Colors
  static const Color secondary = Color(0xFF2563EB); // Medium Blue
  static const Color onSecondary = Color(0xFFFFFFFF);
  static const Color secondaryContainer = Color(0xFFDBEAFE);
  static const Color onSecondaryContainer = Color(0xFF0F1F4B);

  // Tertiary Colors
  static const Color tertiary = Color(0xFF0EA5E9); // Accent Cyan
  static const Color onTertiary = Color(0xFFFFFFFF);
  static const Color tertiaryContainer = Color(0xFFBAE6FD);
  static const Color onTertiaryContainer = Color(0xFF0C4A6E);
  ...
  static const Color surfaceVariant = Color(0xFFF5F7FB);
