import '../models/appointment.dart' as home_appointment;
import '../../../admin/data/models/appointment.dart' as admin_appointment;
...
class AppointmentSyncService {
  static admin_appointment.Appointment convertToAdminFormat(
    ...
    return admin_appointment.Appointment(
      ...
      customerId: 'customer_${homeAppointment.id}',
      customerName: 'Khách hàng ${homeAppointment.id}',
      lawyerId: 'lawyer_${homeAppointment.id}',
